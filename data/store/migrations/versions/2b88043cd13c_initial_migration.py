...
Revision ID: 2b88043cd13c
Revises: 
Create Date: 2025-02-16 17:54:43.208493
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('asset_symbol', 'granularity', 'start', 'end', 'source', 'data_type'),
